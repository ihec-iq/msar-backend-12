...
return new class extends Migration {
    ...
    {
        Schema::create('retrieval_vouchers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('employee_id')->constrained()->onUpdate('cascade')->onDelete('cascade');
            $table->foreignId('retrieval_voucher_item_type_id')->constrained()
    ...
    {
        Schema::dropIfExists('retrieval_vouchers');
    }
};
